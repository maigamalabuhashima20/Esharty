...
class EshartySupabaseUser extends BaseAuthUser {
  EshartySupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> eshartySupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = EshartySupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
